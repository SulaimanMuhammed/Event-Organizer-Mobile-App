...
import SearchScreen from './components/Planner';
...
import { LoginScreen, RegisterScreen } from './components/Login';
      ...
      <NavigationContainer>
        {showRealApp ? (
          ...
          >
            ...
            <Stack.Screen name="Party" component={Party} options={{ headerShown: false, tabBarVisible: false }} />
            <Stack.Screen name="Birthday" component={Birthday} options={{ headerShown: false, tabBarVisible: false }} />
            <Stack.Screen name="BirthdayPage" component={BirthdayPage} options={{ headerShown: false }} />
            <Stack.Screen name="ViewCart" component={ViewCart} options={{ headerShown: false, tabBarVisible: false }} />
            <Stack.Screen name="Login" component={LoginScreen} options={{ headerShown: false, tabBarVisible: false }} />
            <Stack.Screen name="Register" component={RegisterScreen} options={{ headerShown: false, tabBarVisible: false }} />
          </Stack.Navigator>
        ) : (
