          ...
          reservationData.map((order, orderIndex) => (
            <View key={orderIndex} style={styles.eachCart}>
              <View style={styles.infoContainer}>
                ...
                <Text style={styles.infoText}>Name: {order.item.name}</Text>
              ...
              {order.birthdayInfo.map((item, infoIndex) => (
                <View style={styles.infoContainer} key={infoIndex}>
                  ...
                  <Text style={styles.infoText}>Name: {item.personName}</Text>
                  <Text style={styles.infoText}>Musice: {item.music}</Text>
                  <Text style={styles.textInfo}></Text>

                  <Text style={styles.infoText}>
                    Cake Sentence: {item.sentence}
                  </Text>
                  ...
                  <Text style={styles.textInfo}>
                    {new Date(item.selectedTime).toLocaleDateString()}
                  </Text>
